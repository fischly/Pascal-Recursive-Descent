...
const std::vector<TokenType> FIRSTSETS[] = {
    ...
    [PROCCALL] = { TokenType::IDENTIFIER },
    [PARAMS] = { TokenType::BRACKETS_OPEN },
    [ASSIGNSTMT] = { TokenType::IDENTIFIER },
    [ASSIGNSTMT2] = { TokenType::SQUARE_OPEN, TokenType::OP_ASSIGNMENT },
    [INDEX] = { TokenType::SQUARE_OPEN },
    [INDEX2] = { TokenType::SQUARE_CLOSING, TokenType::RANGE_DOTS },
    [IFSTMT] = { TokenType::IF },
    ...
    [FACTOR] = { TokenType::LITERAL_INTEGER,
                 ...
                 TokenType::OP_SUB,
                 TokenType::BRACKETS_OPEN },
    [FACTOR2] = { TokenType::SQUARE_OPEN, TokenType::BRACKETS_OPEN },
